...
$minPhpVersion                                 = '7.2.0';
$arrPermissions                                = [];
$arrPermissions['storage/']                     = __DIR__ . "/storage/";
...
$arrPermissions['storage/app/']                = __DIR__ . "/storage/app/";
...
// If all directory has and .env file has permission then redirect to mail File
if($err != 1)
{
