        ...
        <div class="row mb-4">
            <div class="col-md-3">
                <div>
                    ...
                    <p class="mt-1">{{Utility::dateFormat($task->created_at)}}</p>
                </div>
            </div>
            <div class="col-md-3">
                <div>
                    <div class="font-weight-bold">{{ __('Due Date')}}</div>
                    <p class="mt-1">{{Utility::dateFormat($task->due_date)}}</p>
                </div>
            </div>
            <div class="col-md-3">
                <div>
                        ...
                        @foreach($task->sub_tasks as $subTask)
                            <li class="list-group-item pt-2 pb-0">
                                <label class="custom-switch pl-0">
                                    ...
                                    <span class="custom-switch-description">{{$subTask->name}} <small class="text-dark">{{__('Due Date')}} - {{Utility::dateFormat($subTask->due_date)}}</small></span>
                                </label>
                                <div class="float-right">
