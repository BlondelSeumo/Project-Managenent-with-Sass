    ...
    <table class="table table-striped mb-0" id="dataTable-1">
        ...
        <tr>
            ...
            <td>
                <div class="row cust-checkbox-row">
                    <div class="col custom-control custom-checkbox">
                        <input class="custom-control-input" id="permission22" @if(in_array('show gantt',$permissions)) checked="checked" @endif name="permissions[]" type="checkbox" value="show gantt">
