        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-8">
                ...
                <div class="text-sm-right">
                    <button type="button" class="btn btn-primary btn-rounded mt-4" data-ajax-popup="true" data-title="{{ __('Add Client') }}" data-url="{{route('clients.create',$currantWorkspace->slug)}}">
                        ...
                        <div class="dropdown card-widgets float-right">
                            ...
                            <div class="dropdown card-widgets float-right">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="#" onclick="(confirm('{{__('Are you sure ?')}}')?document.getElementById('delete-form-{{$client->id}}').submit(): '');" class="dropdown-item"><i class="mdi mdi-delete mr-1"></i>{{__('Delete')}}</a>
