                            ...
                            <div data-v-363339a0="" class="d-inner">
                                <div data-v-363339a0="" class="row">
                                    <div data-v-363339a0="" class="col-3">
                                        <h1 data-v-363339a0="" class="fancy-title tu mb5" style="color: {{$color}};">{{__('INVOICE')}}</h1>
                                        <p data-v-363339a0="">@if($currantWorkspace->company){{$currantWorkspace->company}}@endif</p>
                                        <pre data-v-363339a0="">@if($currantWorkspace->address){{$currantWorkspace->address}}@endif</pre>
                                        <p data-v-363339a0="">@if($currantWorkspace->city) {{$currantWorkspace->city}}, @endif @if($currantWorkspace->state){{$currantWorkspace->state}}@endif @if($currantWorkspace->zipcode)- {{$currantWorkspace->zipcode}}@endif</p>
                                        <p data-v-363339a0="">@if($currantWorkspace->country){{$currantWorkspace->country}}@endif</p>
                                        <p data-v-363339a0="">@if($currantWorkspace->telephone){{$currantWorkspace->telephone}}@endif</p>
                                    </div>
                                    <div data-v-363339a0="" class="col-1">
                                        <img data-v-363339a0="" src="@if($currantWorkspace->logo){{asset(Storage::url('logo/'.$currantWorkspace->logo))}}@else{{asset(Storage::url('logo/logo.png'))}}@endif" style="max-width: 150px" class="d-logo">
                                    </div>
                                </div>
                                <div data-v-363339a0="" class="break-50"></div>
                                <div data-v-363339a0="" class="row">
                                    <div data-v-363339a0="" class="col-66">
                                        <strong data-v-363339a0="" class="tu mb5" style="color: {{$color}};">{{__('Bill To')}}:</strong>
                                    ...
                                    <div data-v-363339a0="" class="col-33">
                                        <table data-v-363339a0="" class="summary-table">
                                            ...
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb" style="color: {{$color}};">{{__('Project')}}:</td>
                                            ...
                                            @if($items = $invoice->items)
                                                @foreach($items as $key => $item)
                                                    <div data-v-363339a0="" class="d-table-tr">
                                                        ...
                                                        <div data-v-363339a0="" class="d-table-td w-5 text-right"><span data-v-e95a8a8c="">{{$currantWorkspace->priceFormat($item->price*$item->qty)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @endif
                                        </div>
                                        <div data-v-363339a0="" class="d-table-footer">
                                            ...
                                            <div data-v-363339a0="" class="d-table-summary">
                                                <div data-v-363339a0="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-363339a0="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getSubTotal())}}</div>
                                                </div>
                                                @if($invoice->discount)
                                                    <div data-v-363339a0="" class="d-table-summary-item">
                                                        <div data-v-363339a0="" class="tu d-table-label">{{__('Discount')}}:</div>
                                                        <div data-v-363339a0="" class="d-table-value">- {{$currantWorkspace->priceFormat($invoice->discount)}}</div>
                                                    </div>
                                                @endif
                                                @if($invoice->tax)
                                                    <div data-v-363339a0="" class="d-table-summary-item">
                                                        <div data-v-363339a0="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                        <div data-v-363339a0="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getTaxTotal())}}</div>
                                                    </div>
                                                @endif
                                                <div data-v-363339a0="" class="d-table-summary-item">
                                                    <div data-v-363339a0="" class="fwb f-b tu d-table-label" style="color: {{$color}};">{{__('Total')}}:</div>
                                                    <div data-v-363339a0="" class="fwb f-b d-table-value" style="color: {{$color}};">{{$currantWorkspace->priceFormat($invoice->getTotal())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
