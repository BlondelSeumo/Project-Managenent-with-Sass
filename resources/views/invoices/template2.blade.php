                            ...
                            <div data-v-37eeda86="" class="d-inner">
                                <div data-v-37eeda86="" class="row">
                                    <div data-v-37eeda86="" class="col-2">
                                        <img
                                            src="@if($currantWorkspace->logo){{asset(Storage::url('logo/'.$currantWorkspace->logo))}}@else{{asset(Storage::url('logo/logo.png'))}}@endif"
                                            style="max-width: 150px"/>
                                    </div>
                                    <div data-v-37eeda86="" class="col-2 text-right">
                                        <p>@if($currantWorkspace->company){{$currantWorkspace->company}}@endif</p>
                                        <p>
                                            @if($currantWorkspace->address){{$currantWorkspace->address}}@endif
                                            @if($currantWorkspace->city) <br> {{$currantWorkspace->city}}@endif
                                            @if($currantWorkspace->state), {{$currantWorkspace->state}}@endif
                                            @if($currantWorkspace->zipcode)- {{$currantWorkspace->zipcode}}@endif
                                ...
                                <div data-v-37eeda86="" class="row">
                                    <div data-v-37eeda86="" class="col-66">
                                        <strong class="tu mb5"
                                                style="color: {{$color}};">{{__('Billing Address')}}:</strong>
                                ...
                                <div data-v-37eeda86="" class="d-table">
                                    <div data-v-37eeda86="" class="d-table">
                                        <div data-v-37eeda86="" class="tu d-table-tr"
                                             style="color: {{$color}}; border-bottom: 1px solid {{$color}}; border-top: 1px solid {{$color}};">
                                                ...
                                                @foreach($items as $key => $item)
                                                    <div class="d-table-tr"
                                                        ...
                                                        <div class="d-table-td w-5 text-right">
                                                            <span>{{$currantWorkspace->priceFormat($item->price*$item->qty)}}</span>
                                                        </div>
                                                    </div>
                                                @endforeach
                                            @endif
                                        ...
                                        <div data-v-37eeda86="" class="d-table-footer">
                                            ...
                                            <div class="d-table-summary">
                                                <div class="d-table-summary-item">
                                                    ...
                                                    <div
                                                        class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getSubTotal())}}</div>
                                                </div>
                                                @if($invoice->discount)
                                                    <div class="d-table-summary-item">
                                                        <div class="tu d-table-label">{{__('Discount')}}:</div>
                                                        <div
                                                            class="d-table-value">- {{$currantWorkspace->priceFormat($invoice->discount)}}</div>
                                                    </div>
                                                @endif
                                                @if($invoice->tax)
                                                    <div class="d-table-summary-item">
                                                        ...
                                                        <div
                                                            class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getTaxTotal())}}</div>
                                                    </div>
                                                @endif
                                                <div class="d-table-summary-item"
                                                    ...
                                                    <div
                                                        class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getTotal())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
