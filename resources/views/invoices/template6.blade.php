                        ...
                        <div data-v-4b3dcb8a="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-4b3dcb8a="" class="d-inner" style="border-top: 15px solid {{$color}};">
                                <div data-v-4b3dcb8a="" class="row">
                                    ...
                                    <div data-v-4b3dcb8a="" class="col-1"><img data-v-4b3dcb8a="" src="@if($currantWorkspace->logo){{asset(Storage::url('logo/'.$currantWorkspace->logo))}}@else{{asset(Storage::url('logo/logo.png'))}}@endif" class="d-logo"></div>
                                </div>
                                <div data-v-4b3dcb8a="" class="break-50"></div>
                                <div data-v-4b3dcb8a="" class="row">
                                    <div data-v-4b3dcb8a="" class="col-2">
                                        <small data-v-4b3dcb8a="">{{__('From')}}:</small>
                                        <strong data-v-4b3dcb8a="" class="sub-title">@if($currantWorkspace->company){{$currantWorkspace->company}}@endif</strong>
                                        <pre data-v-4b3dcb8a="">@if($currantWorkspace->address){{$currantWorkspace->address}}@endif</pre>
                                        <p data-v-4b3dcb8a="">@if($currantWorkspace->city) {{$currantWorkspace->city}}, @endif @if($currantWorkspace->state){{$currantWorkspace->state}}@endif @if($currantWorkspace->zipcode)- {{$currantWorkspace->zipcode}}@endif</p>
                                        <p data-v-4b3dcb8a="">@if($currantWorkspace->country){{$currantWorkspace->country}}@endif</p>
                                        <p data-v-4b3dcb8a="">@if($currantWorkspace->telephone){{$currantWorkspace->telephone}}@endif</p>
                                    </div>
                                    <div data-v-4b3dcb8a="" class="col-2">
                                        ...
                                        <div data-v-4b3dcb8a="" class="d-table-footer">
                                            ...
                                            <div data-v-4b3dcb8a="" class="d-table-summary">
                                                <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-4b3dcb8a="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getSubTotal())}}</div>
                                                </div>

                                                @if($invoice->discount)
                                                    <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                        <div data-v-4b3dcb8a="" class="tu d-table-label">{{__('Discount')}}:</div>
                                                        <div data-v-4b3dcb8a="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->discount)}}</div>
                                                    </div>
                                                @endif
                                                @if($invoice->tax)
                                                    <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                        <div data-v-4b3dcb8a="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                        <div data-v-4b3dcb8a="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getTaxTotal())}}</div>
                                                    </div>
                                                @endif
                                                <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                    <div data-v-4b3dcb8a="" class="tu d-table-label"><strong data-v-4b3dcb8a="">{{__('Total')}}:</strong></div>
                                                    <div data-v-4b3dcb8a="" class="d-table-value"><strong data-v-4b3dcb8a="">{{$currantWorkspace->priceFormat($invoice->getTotal())}}</strong></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
