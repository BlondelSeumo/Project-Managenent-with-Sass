                            ...
                            <div data-v-136bf9b5="" class="d-inner">
                                <div data-v-136bf9b5="" class="row">
                                    <div data-v-136bf9b5="" class="col-66">
                                        <img data-v-136bf9b5="" src="@if($currantWorkspace->logo){{asset(Storage::url('logo/'.$currantWorkspace->logo))}}@else{{asset(Storage::url('logo/logo.png'))}}@endif" class="d-logo" style="max-width: 200px;">
                                        <h3 data-v-136bf9b5="">@if($currantWorkspace->company){{$currantWorkspace->company}}@endif</h3>
                                        <pre data-v-136bf9b5="">@if($currantWorkspace->address){{$currantWorkspace->address}}@endif</pre>
                                        <p data-v-136bf9b5="">@if($currantWorkspace->city) {{$currantWorkspace->city}}, @endif @if($currantWorkspace->state){{$currantWorkspace->state}}@endif @if($currantWorkspace->zipcode)- {{$currantWorkspace->zipcode}}@endif</p>
                                        <p data-v-136bf9b5="">@if($currantWorkspace->country){{$currantWorkspace->country}}@endif</p>
                                        <p data-v-136bf9b5="">@if($currantWorkspace->telephone){{$currantWorkspace->telephone}}@endif</p>
                                    </div>
                                            ...
                                            @if($items = $invoice->items)
                                                @foreach($items as $key => $item)
                                                    <div data-v-136bf9b5="" class="d-table-tr">
                                                        ...
                                                        <div data-v-136bf9b5="" class="d-table-td w-5 text-right"><span data-v-136bf9b5="">{{$currantWorkspace->priceFormat($item->price*$item->qty)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @endif
                                        </div>
                                        <div data-v-136bf9b5="" class="d-table-footer">
                                            ...
                                            <div data-v-136bf9b5="" class="d-table-summary">
                                                <div data-v-136bf9b5="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-136bf9b5="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getSubTotal())}}</div>
                                                </div>
                                                @if($invoice->discount)
                                                <div data-v-136bf9b5="" class="d-table-summary-item">
                                                    <div data-v-136bf9b5="" class="d-table-label">{{__('Discount')}}:</div>
                                                    <div data-v-136bf9b5="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->discount)}}</div>
                                                </div>
                                                @endif
                                                @if($invoice->tax)
                                                <div data-v-136bf9b5="" class="d-table-summary-item">
                                                    <div data-v-136bf9b5="" class="d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                    <div data-v-136bf9b5="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getTaxTotal())}}</div>
                                                </div>
                                                @endif
                                                <div data-v-136bf9b5="" class="d-table-summary-item">
                                                    <div data-v-136bf9b5="" class="d-table-label">{{__('Total')}}:</div>
                                                    <div data-v-136bf9b5="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getTotal())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
