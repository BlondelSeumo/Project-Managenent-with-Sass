                        ...
                        <div data-v-b8f60a0c="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-b8f60a0c="" class="d-inner">
                                <div data-v-b8f60a0c="" class="row">
                                    ...
                                    <div data-v-b8f60a0c="" class="col-33"><img data-v-b8f60a0c="" style="max-width: 200px;" class="d-logo" src="@if($currantWorkspace->logo){{asset(Storage::url('logo/'.$currantWorkspace->logo))}}@else{{asset(Storage::url('logo/logo.png'))}}@endif"></div>
                                </div>
                                ...
                                <div data-v-b8f60a0c="" class="row">
                                    <div data-v-b8f60a0c="" class="col-66"><strong data-v-b8f60a0c="" class="tu mb5" style="color: {{$color}};">{{__('From')}}:</strong>
                                        <p data-v-b8f60a0c="">@if($currantWorkspace->company){{$currantWorkspace->company}}@endif@endif</p>
                                        <pre data-v-b8f60a0c="">@if($currantWorkspace->address){{$currantWorkspace->address}}@endif</pre>
                                        <p data-v-b8f60a0c="">@if($currantWorkspace->city) {{$currantWorkspace->city}}, @endif @if($currantWorkspace->state){{$currantWorkspace->state}}@endif @if($currantWorkspace->zipcode)- {{$currantWorkspace->zipcode}}@endif</p>
                                        <p data-v-b8f60a0c="">@if($currantWorkspace->country){{$currantWorkspace->country}}@endif</p>
                                        <p data-v-b8f60a0c="">@if($currantWorkspace->telephone){{$currantWorkspace->telephone}}@endif</p>
                                    </div>
                                    <div data-v-b8f60a0c="" class="col-33">
                                        <table data-v-b8f60a0c="" class="summary-table">
                                            ...
                                            <tr data-v-b8f60a0c="">
                                                <td data-v-b8f60a0c="" class="tu fwb" style="color: {{$color}};">{{__('Project')}}:</td>
                                ...
                                <div data-v-b8f60a0c="" class="row">
                                    <div data-v-b8f60a0c="" class="col-2">
                                        <div data-v-b8f60a0c="" class="col-66"><strong data-v-b8f60a0c="" class="tu mb5" style="color: {{$color}};">{{__('To')}}:</strong>
                                            ...
                                            @if($items = $invoice->items)
                                                @foreach($items as $key => $item)
                                                    <div data-v-b8f60a0c="" class="d-table-tr">
                                                        ...
                                                        <div data-v-b8f60a0c="" class="d-table-td w-5 text-right"><span data-v-b8f60a0c="">{{$currantWorkspace->priceFormat($item->price*$item->qty)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @endif
                                        </div>
                                        <div data-v-b8f60a0c="" class="d-table-footer">
                                            ...
                                            <div data-v-b8f60a0c="" class="d-table-summary">
                                                <div data-v-b8f60a0c="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-b8f60a0c="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getSubTotal())}}</div>
                                                </div>
                                                @if($invoice->discount)
                                                <div data-v-b8f60a0c="" class="d-table-summary-item">
                                                    <div data-v-b8f60a0c="" class="tu d-table-label">{{__('Discount')}}:</div>
                                                    <div data-v-b8f60a0c="" class="d-table-value">- {{$currantWorkspace->priceFormat($invoice->discount)}}</div>
                                                </div>
                                                @endif
                                                @if($invoice->tax)
                                                <div data-v-b8f60a0c="" class="d-table-summary-item">
                                                    <div data-v-b8f60a0c="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                    <div data-v-b8f60a0c="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getTaxTotal())}}</div>
                                                </div>
                                                @endif
                                                <div data-v-b8f60a0c="" class="d-table-summary-item" style="color: white; background: {{$color}};">
                                                    ...
                                                    <div data-v-b8f60a0c="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getTotal())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
