                        ...
                        <div data-v-e95a8a8c="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-e95a8a8c="" class="d-inner">
                                <div data-v-e95a8a8c="" class="row">
                                    <div data-v-e95a8a8c="" class="col-3"><h1 data-v-e95a8a8c="" class="fancy-title tu mb5" style="color: {{$color}};">{{__('INVOICE')}}</h1></div>
                                    <div data-v-e95a8a8c="" class="col-1"><img data-v-e95a8a8c="" src="@if($currantWorkspace->logo){{asset(Storage::url('logo/'.$currantWorkspace->logo))}}@else{{asset(Storage::url('logo/logo.png'))}}@endif" style="max-width: 150px" class="d-logo"></div>
                                </div>
                                ...
                                <div data-v-e95a8a8c="" class="row">
                                    <div data-v-e95a8a8c="" class="col-66"><strong data-v-e95a8a8c="" class="tu mb5" style="color: {{$color}};">{{__('From')}}:</strong>
                                        <p data-v-e95a8a8c="">@if($currantWorkspace->company){{$currantWorkspace->company}}@endif</p>
                                        <pre data-v-e95a8a8c="">@if($currantWorkspace->address){{$currantWorkspace->address}}@endif</pre>
                                        <p data-v-e95a8a8c="">@if($currantWorkspace->city) {{$currantWorkspace->city}}, @endif @if($currantWorkspace->state){{$currantWorkspace->state}}@endif @if($currantWorkspace->zipcode)- {{$currantWorkspace->zipcode}}@endif</p>
                                        <p data-v-e95a8a8c="">@if($currantWorkspace->country){{$currantWorkspace->country}}@endif</p>
                                        <p data-v-e95a8a8c="">@if($currantWorkspace->telephone){{$currantWorkspace->telephone}}@endif</p>
                                    </div>
                                    <div data-v-e95a8a8c="" class="col-33">
                                        <table data-v-e95a8a8c="" class="summary-table">
                                            ...
                                            <tr data-v-e95a8a8c="">
                                                <td data-v-e95a8a8c="" class="tu fwb" style="color: {{$color}};">{{__('Project')}}:</td>
                                ...
                                <div data-v-e95a8a8c="" class="row">
                                    <div data-v-e95a8a8c="" class="col-3">
                                        <div data-v-e95a8a8c="" class="col-80"><strong data-v-e95a8a8c="" class="tu mb5" style="color: {{$color}};">{{__('To')}}:</strong>
                                            ...
                                            @if($items = $invoice->items)
                                                @foreach($items as $key => $item)
                                                    <div data-v-e95a8a8c="" class="d-table-tr" style="border-bottom: 1px solid {{$color}};">
                                                        ...
                                                        <div data-v-e95a8a8c="" class="d-table-td w-5 text-right"><span data-v-e95a8a8c="">{{$currantWorkspace->priceFormat($item->price*$item->qty)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @endif
                                        </div>
                                        <div data-v-e95a8a8c="" class="d-table-footer">
                                            ...
                                            <div data-v-e95a8a8c="" class="d-table-summary">
                                                <div data-v-e95a8a8c="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-e95a8a8c="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getSubTotal())}}</div>
                                                </div>
                                                @if($invoice->discount)
                                                    <div data-v-e95a8a8c="" class="d-table-summary-item">
                                                        <div data-v-e95a8a8c="" class="tu d-table-label">{{__('Discount')}}:</div>
                                                        <div data-v-e95a8a8c="" class="d-table-value">- {{$currantWorkspace->priceFormat($invoice->discount)}}</div>
                                                    </div>
                                                @endif
                                                @if($invoice->tax)
                                                    <div data-v-e95a8a8c="" class="d-table-summary-item">
                                                        <div data-v-e95a8a8c="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                        <div data-v-e95a8a8c="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getTaxTotal())}}</div>
                                                    </div>
                                                @endif
                                                <div data-v-e95a8a8c="" class="d-table-summary-item" style="border: 2px solid {{$color}};">
                                                    ...
                                                    <div data-v-e95a8a8c="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getTotal())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
