                        ...
                        <div data-v-7d9d14b5="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-7d9d14b5="" class="d-inner" style="border-right: 50px solid {{$color}};">
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-3"><h1 data-v-7d9d14b5="" class="fancy-title tu mb5" style="color: {{$color}};">{{__('INVOICE')}}</h1>
                                    ...
                                    <div data-v-7d9d14b5="" class="col-1"><img data-v-7d9d14b5="" class="d-logo" src="@if($currantWorkspace->logo){{asset(Storage::url('logo/'.$currantWorkspace->logo))}}@else{{asset(Storage::url('logo/logo.png'))}}@endif" style="max-width: 150px;"></div>
                                </div>
                                <div data-v-7d9d14b5="" class="break-50"></div>
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-33">
                                        <h3 data-v-7d9d14b5="" class="sub-title">@if($currantWorkspace->company){{$currantWorkspace->company}}@endif</h3>
                                        <pre data-v-7d9d14b5="">@if($currantWorkspace->address){{$currantWorkspace->address}}@endif</pre>
                                        <p data-v-7d9d14b5="">@if($currantWorkspace->city) {{$currantWorkspace->city}}, @endif @if($currantWorkspace->state){{$currantWorkspace->state}}@endif @if($currantWorkspace->zipcode)- {{$currantWorkspace->zipcode}}@endif</p>
                                        <p data-v-7d9d14b5="">@if($currantWorkspace->country){{$currantWorkspace->country}}@endif</p>
                                        <p data-v-7d9d14b5="">@if($currantWorkspace->telephone){{$currantWorkspace->telephone}}@endif</p>
                                    </div>
                                    <div data-v-7d9d14b5="" class="col-33">
                                            ...
                                            @if($items = $invoice->items)
                                                @foreach($items as $key => $item)
                                                    <div data-v-7d9d14b5="" class="d-table-tr" style="border-bottom: 1px solid rgb(248, 248, 248);">
                                                        ...
                                                        <div data-v-7d9d14b5="" class="d-table-td w-5 text-right" style="padding: 3px;"><span data-v-7d9d14b5="">{{$currantWorkspace->priceFormat($item->price*$item->qty)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @endif
                                        </div>
                                        <div data-v-7d9d14b5="" class="d-table-footer">
                                            ...
                                            <div data-v-7d9d14b5="" class="d-table-summary">
                                                <div data-v-7d9d14b5="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-7d9d14b5="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getSubTotal())}}</div>
                                                </div>
                                                @if($invoice->discount)
                                                <div data-v-7d9d14b5="" class="d-table-summary-item">
                                                    <div data-v-7d9d14b5="" class="tu d-table-label">{{__('Discount')}}:</div>
                                                    <div data-v-7d9d14b5="" class="d-table-value">- {{$currantWorkspace->priceFormat($invoice->discount)}}</div>
                                                </div>
                                                @endif
                                                @if($invoice->tax)
                                                <div data-v-7d9d14b5="" class="d-table-summary-item">
                                                    <div data-v-7d9d14b5="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                    <div data-v-7d9d14b5="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getTaxTotal())}}</div>
                                                </div>
                                                @endif
                                                <div data-v-7d9d14b5="" class="d-table-summary-item" style="background: {{$color}}; color: white;">
                                                    <div data-v-7d9d14b5="" class="tu d-table-label">{{__('Total')}}:</div>
                                                    <div data-v-7d9d14b5="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getTotal())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
