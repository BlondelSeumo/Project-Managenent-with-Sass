                                    ...
                                    <div data-v-f2a183a6="" class="d-header-inner">
                                        <div data-v-f2a183a6="" class="d-header-50">
                                            <div data-v-f2a183a6="" class="d-header-brand">
                                                <img src="@if($currantWorkspace->logo){{asset(Storage::url('logo/'.$currantWorkspace->logo))}}@else{{asset(Storage::url('logo/logo.png'))}}@endif" style="max-width: 100px"/>
                                            </div>
                                            <div data-v-f2a183a6="" class="break-25"></div>
                                            <p data-v-f2a183a6="">@if($currantWorkspace->company){{$currantWorkspace->company}}@endif</p>
                                            <p>
                                                ...
                                                @if($items = $invoice->items)
                                                    @foreach($items as $key => $item)
                                                        <div class="d-table-tr" style="border-bottom:1px solid {{$color}};">
                                                            ...
                                                            <div  class="d-table-td w-5 text-right"><span >{{$currantWorkspace->priceFormat($item->price*$item->qty)}}</span></div>
                                                        </div>
                                                    @endforeach
                                                @endif
                                            </div>
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getSubTotal())}}</div>
                                                    </div>
                                                    @if($invoice->discount)
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label">{{__('Discount')}}:</div>
                                                            <div data-v-f2a183a6="" class="d-table-value">- {{$currantWorkspace->priceFormat($invoice->discount)}}</div>
                                                        </div>
                                                    @endif
                                                    @if($invoice->tax)
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                            <div data-v-f2a183a6="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getTaxTotal())}}</div>
                                                        </div>
                                                    @endif
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid {{$color}}; border-bottom: 1px solid {{$color}};">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getTotal())}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
