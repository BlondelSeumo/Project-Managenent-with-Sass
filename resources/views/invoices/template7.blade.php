                        ...
                        <div data-v-1ad6e3b9="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-1ad6e3b9="" class="d-inner d-no-pad" style="border-top: 15px solid {{$color}}; border-bottom: 15px solid {{$color}};">
                                <div data-v-1ad6e3b9="" class="row grey-box">
                                    <div data-v-1ad6e3b9="" class="col-33"><img data-v-1ad6e3b9="" src="@if($currantWorkspace->logo){{asset(Storage::url('logo/'.$currantWorkspace->logo))}}@else{{asset(Storage::url('logo/logo.png'))}}@endif" class="d-logo" style="max-width: 200px;"> <br data-v-1ad6e3b9=""><br data-v-1ad6e3b9="">
                                        <p data-v-1ad6e3b9="">@if($currantWorkspace->company){{$currantWorkspace->company}}@endif</p>
                                        <pre data-v-1ad6e3b9="">@if($currantWorkspace->address){{$currantWorkspace->address}}@endif</pre>
                                        <p data-v-1ad6e3b9="">@if($currantWorkspace->city) {{$currantWorkspace->city}}, @endif @if($currantWorkspace->state){{$currantWorkspace->state}}@endif @if($currantWorkspace->zipcode)- {{$currantWorkspace->zipcode}}@endif</p>
                                        <p data-v-1ad6e3b9="">@if($currantWorkspace->country){{$currantWorkspace->country}}@endif</p>
                                        <p data-v-1ad6e3b9="">@if($currantWorkspace->telephone){{$currantWorkspace->telephone}}@endif</p>
                                    </div>
                                                ...
                                                @if($items = $invoice->items)
                                                    @foreach($items as $key => $item)
                                                        <div data-v-1ad6e3b9="" class="d-table-tr">
                                                            ...
                                                            <div data-v-1ad6e3b9="" class="d-table-td w-5 text-right" style="border: 1px solid {{$color}}; padding: 5px;"><span data-v-1ad6e3b9="">{{$currantWorkspace->priceFormat($item->price*$item->qty)}}</span></div>
                                                        </div>
                                                    @endforeach
                                                @endif
                                            </div>
                                            <div data-v-1ad6e3b9="" class="d-table-footer">
                                                ...
                                                <div data-v-1ad6e3b9="" class="d-table-summary">
                                                    <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-1ad6e3b9="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getSubTotal())}}</div>
                                                    </div>
                                                    @if($invoice->discount)
                                                        <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                            <div data-v-1ad6e3b9="" class="tu d-table-label">{{__('Discount')}}:</div>
                                                            <div data-v-1ad6e3b9="" class="d-table-value">- {{$currantWorkspace->priceFormat($invoice->discount)}}</div>
                                                        </div>
                                                    @endif
                                                    @if($invoice->tax)
                                                        <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                            <div data-v-1ad6e3b9="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                            <div data-v-1ad6e3b9="" class="d-table-value">{{$currantWorkspace->priceFormat($invoice->getTaxTotal())}}</div>
                                                        </div>
                                                    @endif
                                                    <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                        <div data-v-1ad6e3b9="" class="tu d-table-label"><strong data-v-1ad6e3b9="">{{__('Total')}}:</strong></div>
                                                        <div data-v-1ad6e3b9="" class="d-table-value"><strong data-v-1ad6e3b9="">{{$currantWorkspace->priceFormat($invoice->getTotal())}}</strong></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
